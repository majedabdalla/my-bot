...
async def cmd_profile(message: types.Message, state: FSMContext):
    ...
    if user:
        ...
        await message.answer("What would you like to edit?", reply_markup=InlineKeyboardMarkup().add(
            InlineKeyboardButton("Language", callback_data="edit_lang"),
            InlineKeyboardButton("Gender", callback_data="edit_gender"),
            InlineKeyboardButton("Continent", callback_data="edit_continent"),
            InlineKeyboardButton("Age", callback_data="edit_age")
        ))
    else:
        await message.answer("Your profile is not set up yet. Please use /start.")
...
async def edit_profile_field(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if field == 'lang':
        await callback_query.message.edit_text("Please choose your language:", reply_markup=InlineKeyboardMarkup().add(
            InlineKeyboardButton("English", callback_data="lang_en"),
            InlineKeyboardButton("العربية", callback_data="lang_ar"),
            InlineKeyboardButton("हिन्दी", callback_data="lang_hi"),
            InlineKeyboardButton("Bahasa Indonesia", callback_data="lang_id")
